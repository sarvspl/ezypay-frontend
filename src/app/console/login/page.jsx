  ...
  return (
    <main className="min-h-screen bg-slate-50 flex flex-col items-center justify-center px-4 py-10">
      ...
      <div className="mt-6 flex items-center gap-2">
        <span className="inline-flex items-center gap-1 rounded-full bg-slate-900 text-white px-2.5 py-0.5 text-[11px] font-semibold uppercase tracking-wider">
          <ShieldIcon /> Console
        </span>
        <span className="text-slate-600 text-sm">Staff sign in</span>
      </div>
      ...
      <p className="mt-6 text-sm text-slate-500">
        <Link href="/" className="hover:text-brand-600">← Back to site</Link>
      </p>
    </main>
  );
}
